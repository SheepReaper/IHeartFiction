...
internal sealed class CreateBookChapter(
    FictionDbContext context,
    IMongoCollection<WorkBody> workBodies,
    AuthorizationService authorizationService,
    TimeProvider dateTimeProvider,
    IOptions<MarkdownOptions> markdownOptions,
    IHostEnvironment environment) : IUseCase, INameEndpoint<CreateBookChapter>
{
    ...
    internal sealed record CreateBookChapterBody(
    ...
    internal sealed record CreateBookChapterResponse(
        Ulid BookId,
        string BookTitle,
    ...
    public async Task<Result<CreateBookChapterResponse>> HandleAsync(
        Ulid bookId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            Chapter chapter = new()
            {
                ...
                Order = book.Chapters.Select(c => c.Order).DefaultIfEmpty(-1).Max() + 1
            };
    ...
    public static string EndpointName => nameof(CreateBookChapter);
    ...
    internal sealed class Endpoint : IEndpoint
    {
        ...
        public RouteHandlerBuilder MapEndpoint(IEndpointRouteBuilder builder)
        {
            return builder.MapPost("books/{id:ulid}/chapters", async (
                [FromRoute] Ulid id,
                [AsParameters] CreateBookChapterQuery query,
                [FromBody] CreateBookChapterBody body,
                CreateBookChapter useCase,
                ClaimsPrincipal claimsPrincipal,
            ...
            .Produces<Linked<CreateBookChapterResponse>>(StatusCodes.Status201Created)
            .Accepts<CreateBookChapterBody>(MediaTypeNames.Application.Json);
        }
    }
}
