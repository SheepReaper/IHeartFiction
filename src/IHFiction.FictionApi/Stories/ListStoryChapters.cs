...
internal sealed class ListStoryChapters(
    EntityLoaderService entityLoader,
    IPaginationService paginator) : IUseCase, INameEndpoint<ListStoryChapters>
{
    ...
    internal sealed record Query(
        ...
        [property: ShapesType<ListStoryChaptersItem>]
        string? Fields = null
    ) : IDataShapingSupport;
    ...
    public async Task<Result<PagedCollection<ListStoryChaptersItem>>> HandleAsync(
        Ulid id,
    ...
    public static string EndpointName => nameof(ListStoryChapters);
    ...
    internal sealed class Endpoint : IEndpoint
    {
        ...
        public RouteHandlerBuilder MapEndpoint(IEndpointRouteBuilder builder)
        {
            ...
            .Produces<LinkedPagedCollection<ListStoryChaptersItem>>();
        }
    }
}
