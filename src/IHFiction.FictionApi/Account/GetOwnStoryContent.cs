    ...
    AuthorizationService authorizationService) : IUseCase, INameEndpoint<GetOwnStoryContent>
{
    ...
    internal record ChapterSummaryItem(Ulid Id, string Title, int Order, DateTime? PublishedAt);
    ...
    internal record BookSummaryItem(Ulid Id, string Title, string Description, int Order, DateTime? PublishedAt);
    ...
    public async Task<Result<GetOwnStoryContentResponse>> HandleAsync(
        Ulid id,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var chapterSummaries = story.Chapters.Select(c => new ChapterSummaryItem(c.Id, c.Title, c.Order, c.PublishedAt)).ToList();
        var bookSummaries = story.Books.Select(b => new BookSummaryItem(b.Id, b.Title, b.Description, b.Order, b.PublishedAt)).ToList();

        return new GetOwnStoryContentResponse(
            story.Id,
            story.Title,
            story.Description,
            story.IsPublished,
    ...
    internal sealed class Endpoint : IEndpoint
    {
        ...
        public RouteHandlerBuilder MapEndpoint(IEndpointRouteBuilder builder)
        {
            ...
            .Produces<Linked<GetOwnStoryContentResponse>>();
        }
    }
}
