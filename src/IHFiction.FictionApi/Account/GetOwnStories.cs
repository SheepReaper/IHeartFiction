...
internal sealed class GetOwnStories(
    FictionDbContext context,
    AuthorizationService authorizationService,
    IPaginationService paginator) : IUseCase, INameEndpoint<GetOwnStories>
{
    /// <summary>
    ...
    internal sealed record GetOwnStoriesBody(
    ...
    public static string EndpointName => nameof(GetOwnStories);
    ...
    internal sealed class Endpoint : IEndpoint
    {
        ...
        public RouteHandlerBuilder MapEndpoint(IEndpointRouteBuilder builder)
        {
            ...
            .Accepts<GetOwnStoriesBody>(true, MediaTypeNames.Application.Json)
