...
/// <summary>
/// Edge case and error scenario integration tests for GetAuthor
/// Tests boundary conditions, error handling, and unusual scenarios with database
/// </summary>
// [Collection(nameof(AuthorsTestCollection))]
public class GetAuthorEdgeCaseTests : BaseIntegrationTest, IConfigureServices<GetAuthorEdgeCaseTests>, IAsyncLifetime
{
    private readonly FictionDbContext _dbContext;
    private readonly GetAuthor _useCase;

    public GetAuthorEdgeCaseTests(IntegrationTestWebAppFactory factory) : base(factory)
    {
        _dbContext = _scope.ServiceProvider.GetKeyedService<FictionDbContext>(nameof(GetAuthorEdgeCaseTests)) ?? throw new Exception("DbContext not found");
