...
/// <summary>
/// Unit tests for GetCurrentAuthorStories functionality
/// Tests request validation and response model construction
/// </summary>
public class GetCurrentAuthorStoriesTests
{
    [Fact]
    public void GetCurrentAuthorStoriesRequest_WithDefaultValues_IsValid()
    {
        // Arrange
        var request = new GetCurrentAuthorStories.Query();
    ...
    [Fact]
    public void GetCurrentAuthorStoriesRequest_WithValidCustomValues_IsValid()
    {
        // Arrange
        var request = new GetCurrentAuthorStories.GetCurrentAuthorStoriesBody(
    ...
    [Fact]
    public void GetCurrentAuthorStoriesRequest_WithInvalidPageSize_FailsValidation()
    {
        // Arrange
        var request = new GetCurrentAuthorStories.Query
        {
    ...
    [Fact]
    public void GetCurrentAuthorStoriesRequest_WithTooLargePageSize_FailsValidation()
    {
        // Arrange
        var request = new GetCurrentAuthorStories.Query
        {
    ...
    [Fact]
    public void GetCurrentAuthorStoriesRequest_WithInvalidPage_FailsValidation()
    {
        // Arrange
        var request = new GetCurrentAuthorStories.Query
        {
    ...
    [Fact]
    public void GetCurrentAuthorStoriesRequest_WithTooLongSearch_FailsValidation()
    {
        // Arrange
    ...
    [Fact]
    public void GetCurrentAuthorStoriesRequest_WithHarmfulContentInSearch_FailsValidation()
    {
        // Arrange
        var request = new GetCurrentAuthorStories.Query
        {
    ...
    public void AuthorStoryItem_CanBeCreated()
    {
        ...
        // Act
        var item = new GetCurrentAuthorStories.AuthorStoryItem(
            id,
            "Test Story",
            "Test Description",
            now,
    ...
    public void PaginatedCollectionResponse_CanBeCreated()
    {
        ...
        var stories = new[]
        {
            new GetCurrentAuthorStories.AuthorStoryItem(
                Ulid.NewUlid(),
                "Story 1",
                "Description 1",
                DateTime.UtcNow,
        ...
        // Act
        var response = new PagedCollection<GetCurrentAuthorStories.AuthorStoryItem>(
            stories.AsQueryable(),
            25,
            2,
            10);
    ...
    {
        // Arrange
        var stories = Array.Empty<GetCurrentAuthorStories.AuthorStoryItem>();
