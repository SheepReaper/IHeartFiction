...
/// <summary>
/// Behavior tests for GetAuthor using NSubstitute for interface mocking
/// These tests focus on testing behaviors, interactions, and business logic
/// </summary>
public class GetAuthorBehaviorTests
{
    [Theory]
    [InlineData("")]
    [InlineData("   ")]
    ...
    public void Work_WithEmptyUlid_IsValid()
    {
        ...
        // Act
        var work = new GetAuthor.AuthorWorkItem(emptyId, title, null);
    ...
    public void Work_WithMaxUlid_IsValid()
    {
        ...
        // Act
        var work = new GetAuthor.AuthorWorkItem(maxId, title, null);
    ...
    public void Work_WithVariousTitles_HandlesCorrectly(string title)
    {
        ...
        // Act
        var work = new GetAuthor.AuthorWorkItem(id, title, null);
