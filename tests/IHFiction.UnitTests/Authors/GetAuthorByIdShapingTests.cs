...
public class GetAuthorByIdShapingTests
{
    [Fact]
    public void WithLinks_And_ShapeData_Flattens_LinkedWrapper()
    {
        ...
        var response = new GetAuthorById.GetAuthorByIdResponse(
            ...
            DeletedAt: null,
            Profile: new GetAuthorById.AuthorProfile("Bio text"),
            PublishedStories: new[] { new GetAuthorById.AuthorWorkItem(Ulid.NewUlid(), "Story 1", DateTime.UtcNow) },
            TotalStories: 1
        );
        ...
        var linkedValue = linkedResult.Value!; // Linked<GetAuthorByIdResponse>
        ...
        // Assert - top-level properties from GetAuthorByIdResponse should exist
