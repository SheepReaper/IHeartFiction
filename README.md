...
IHeartFiction is an ambitious open-source project to build a modern, feature-rich platform for authors and readers of original and fan fiction. Our goal is to create a viable competitor to established platforms like Fanfiction.net and Archive Of Our Own (AO3), focusing on a clean user experience, powerful authoring tools, and a vibrant community.

The initial phase of the project is focused on delivering the core functionality: a robust platform to publish, discover, and read fiction. Future development will be guided by community feedback and demand.
